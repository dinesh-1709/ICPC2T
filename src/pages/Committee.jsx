...
function getInitials(name) {
  return name
    .split(' ')
    .filter((n) => !['Dr.', 'Prof.', 'Mr.', 'Ms.', 'Shri.'].includes(n))
    .slice(0, 2)
    .map((n) => n[0])
    .join('');
}
  ...
  return (
    <div className="card p-4 flex items-start gap-3 hover:border-blue-200 transition-colors group">
      ...
      <div className="min-w-0">
        <p className="font-semibold text-gray-900 text-sm leading-tight group-hover:text-blue-700 transition-colors">
          {member.name}
        </p>
        ...
        {member.email && (
          <a
            ...
            className="text-blue-600 text-xs mt-0.5 block hover:underline truncate"
          >
            ✉️ {member.email}
          </a>
        )}
...
function CommitteeSection({ title, members, cols = 3 }) {
  return (
    <motion.div
      initial="hidden"
      whileInView="show"
    ...
    >
      <div className="flex items-center gap-3 mb-4">
        ...
        <span className="tag text-xs ml-auto">
  ...
  return (
    <div className="pt-[88px] bg-[#fffbf7] min-h-screen">
      <div className="page-banner">
        <div className="max-w-[1280px] mx-auto px-4 md:px-8">
          ...
          <p className="text-blue-100 mt-4 text-sm">
            ICPC2T 2027 — NIT Raipur, Chhattisgarh
          </p>
        </div>
      </div>
      ...
      <div className="section-pad">
        ...
        <CommitteeSection title="Patron(s)" members={patrons} />
        ...
        <div className="mt-16 pt-10 border-t border-gray-200">
          ...
          <CommitteeSection
            ...
            members={internationalAdvisory}
          />

          <CommitteeSection
            title="National Advisory Board"
            members={nationalAdvisory}
          />
        </div>
